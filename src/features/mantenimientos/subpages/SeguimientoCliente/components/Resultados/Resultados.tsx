...
export const Resultados = () => {
  ...
  const [uploadedFile, setUploadedFile] = useState<{ name: string; base64: string; extension?: string } | null>(null);
  ...
  const handleUploadExcel = (data: any) => {
    console.log(data)
    const processedData = data[0]; // Asumimos que el primer objeto contiene los datos
